...
$slideshow = {
    ...
    init: function() {
        this.context = jQuery('#rtbanner-slideshow');
        this.tabs = jQuery('ul.rtslideshow-nav li', this.context);
        this.tabs.remove();
        this.startSlideshow();
    },
    
    startSlideshow: function() {
        jQuery('div.rtcontent-slideshow > ul', $slideshow.context).cycle({
            fx: $slideshow.fx,
            pager: jQuery('ul.rtslideshow-nav', $slideshow.context),
